...
INSERT INTO schema_crud.users (id, first_name, last_name, age, email, password)
...
INSERT INTO schema_crud.roles (id, name)
VALUES (1, 'ROLE_ADMIN');
...
INSERT INTO schema_crud.users_roles (user_id, role_id)
VALUES (1, 1);
